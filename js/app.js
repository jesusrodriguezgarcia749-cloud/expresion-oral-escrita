// Expresión Oral y Escrita — app.js
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Buscador (redirige al compendio con el término como query param;
  // compendio.js lee ese parámetro y filtra los subtemas).
  ...
  if (musica && musicaBtn) {
    const PREF_KEY = 'eoe_musica_activa';
    musica.volume = 0.35;
