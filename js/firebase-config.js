// firebase-config.js — Expresión Oral y Escrita
//
// Authentication (correo/contraseña) debe estar activado en este proyecto de
// Firebase (Authentication → habilitar Correo/Contraseña → Add user) para
// poder entrar al Panel docente. Storage NO se está usando por ahora:
// Firebase exige el plan Blaze (con tarjeta registrada) para habilitarlo, y
// se decidió no alojar los libros de referencia de terceros por costo y por
// derechos de autor. La biblioteca queda lista para alojar material propio
// en el futuro si se decide activar Storage más adelante.
...
export const DOMINIO_INSTITUCIONAL = "itesrenedescartes.edu.mx";
